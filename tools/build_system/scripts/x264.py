...
class x264(Base):
    def __init__(self):
        ...
        self.compilers = [config.COMPILER_MAC_GCC,config.COMPILER_MAC_CLANG,config.COMPILER_WIN_MSVC2010, config.COMPILER_UNIX_GCC] # config.COMPILER_WIN_MSVC2010, config.COMPILER_WIN_MSVC2012, 
